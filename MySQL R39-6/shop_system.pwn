...
new pInfo[MAX_PLAYERS][PlayersData], Socket:gSocket, connectionHandle;
...
public OnAccountCheck(playerid) {
	...
	if(rows) {
		...
		cache_get_field_content(0, "Password", pInfo[playerid][playerPass], connectionHandle, 129);
...
public OnAccountLoad(playerid) {
	...
	pInfo[playerid][playerMoney] = cache_get_field_content_int(0, "Money");
